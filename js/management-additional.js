...
.additional-file-current{font-size:12px;color:#6b8295;margin-top:6px;overflow-wrap:anywhere}.additional-file-current b{color:#315b7a}
...
function controlHtml(def,value){
  ...
  if(type==='LIST'||type==='FILE'){
    ...
    if(type==='FILE'){
      ...
      const current=value?`<div class="additional-file-current"><b>Guardado:</b> ${val}</div>`:'';
